                    ...
                    <div class="col-sm-7">
                        ...
                        <form action="code.php" method="POST">
                            <div class="form-group">
                              ...
                              <input name="subject" class="form-control" id="subject"></input>
                            </div>
                            <div class="form-group">
                              <label for="message">Message:</label>
                              <textarea name="message" class="form-control form-control-comment" id="message"></textarea>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-green" name="contactbtn" >Contact us</button>
                            </div>
                            <?php
