                    ...
                    <div class="col-sm-7">
                        ...
                        <form action="code.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                      <input name="passwd" type="password" class="form-control" required placeholder="Password">
                                      <br>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                                    <div class="form-group">
                                      <input name="cpasswd" type="password" class="form-control" required placeholder="Confirm Password">
                                      <br>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button class="btn btn-green" name="registerbtn">Register</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-sm-5">
